...
|----------|--------|-------|
| Concept Understanding | 20% | Built 2 apps from scratch understanding every component |
| Problem-Solving | 25% | Solved EMFILE errors, SDK incompatibility, API integration |
| Quality and Originality | 25% | Original UI design, clean code structure, proper error handling |
| Documentation | 15% | README in each app, progress notes each week |
| Consistency | 15% | Delivered all 6 weeks on schedule |

---

## Demo Videos
> Record a short screen recording on your phone showing:
> 1. Weather App — open app, show GPS weather, search a city, show forecast
> 2. E-Commerce App — browse products, add to cart, checkout, view order history

- Weather App demo: `[add your screen recording link here]`
- E-Commerce App demo: `[add your screen recording link here]`

---

## LinkedIn Post
> **MANDATORY per program guidelines — tag @InternCareerPath**

Suggested caption:

🚀 Excited to share that I've completed my 6-week App Development Internship at @InternCareerPath!

During this internship I built 2 complete mobile apps from scratch using React Native + Expo:
...
#ReactNative #Expo #MobileAppDevelopment #InternCareerPath #AppDevelopment #JavaScript

---

## Submission Checklist
- [x] Minimum 2 completed apps
- [x] Original work with documentation
- [x] GitHub repository public and structured correctly
- [x] All weekly folders present (Week1 - Week6)
- [ ] Demo videos recorded and linked
- [ ] LinkedIn post published tagging @InternCareerPath
- [ ] Repository link submitted on internship portal
